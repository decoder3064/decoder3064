...
[![GitHub](https://img.shields.io/badge/decoder3064-100000?style=flat-square&logo=github&logoColor=white)](https://github.com/decoder3064)
...
<table border="0"><tr>
<td width="130" valign="middle"><pre>
 ╭──────╮
 │(◕‿◕ )│
 ╰──┬───╯
  ──┼──
...
**Languages**
`Python` `Java` `TypeScript` `JavaScript` `PHP` `SQL` `Kotlin` `C`

**Backend**
`Laravel` `FastAPI` `Flask` `Node.js` `Express` `Fastify` `Celery`

**Frontend**
`React` `Next.js`

**Data & Infra**
`PostgreSQL` `Redis` `Firebase` `Supabase` `Prisma` `SQLAlchemy` `Docker` `Railway`

**Concepts**
`REST APIs` `Microservices` `JWT/OAuth` `RBAC` `Queue Systems` `Webhooks` `CI/CD`
